...
<div class="header">
  ...
  {{-- <div class="header-right">
    ...
    <a href="http://localhost/portfolio/public/addemrgncy">Emergency Contacts</a>
...
<div style="padding-left:20px">
   <h1 style="color:white">Emergency Dashboard</h1>
...
<tr>
        ...
        <td>
            ...
            <a href="{{URL::to('delete/emergencyinfo/'.$row->id) }}" class="btn btn-sn btn-danger">Delete</a>
            <a href="{{URL::to('edit/showemrgncy/'.$row->id) }}" class="btn btn-sn btn-success">Update</a>
        </td>
    </tr>
   @endforeach
...
<br>
<a href="http://localhost/portfolio/public/adminpage" class="button">Close</a> 
</body>
</html>
